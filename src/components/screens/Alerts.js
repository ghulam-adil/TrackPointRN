...
class Alerts extends Component {
    ...
    static navigationOptions = {
        header: null,
        // drawerLabel: 'Alert Management',
        // drawerIcon: ({ tintColor }) => (
        //     <MaterialIcon name='warning' size={24} color={tintColor} />
        // )
    };

    state = {
        liveData: [
            {id: '1', vrn: 'TGH-547', alertType: 'Ignition On', speed: 16.0, time: '5 Mins', ignition: 'on', status: 'moving'},
            {id: '2', vrn: 'ABC-258', alertType: 'Ignition Off', speed: 5.0, time: '15 Mins', ignition: 'off', status: 'parked'},
            {id: '3', vrn: 'XYZ-936', alertType: 'Ignition On', speed: 99.0, time: '8 Mins', ignition: 'on', status: 'idle'},
        ],
        isSearch: false,
        value: '',
    }
        ...
        else
        {
            return(
                ...
                <View style={styles.header}>
                    ...
                    <View style={{ width: '80%' }}>
                        <Text style={styles.headerText}>Alert Management</Text>
                    </View>
        ...
        return(
            <View style={{ flex: 1 }}>
                ...
                <Grid 
                    ...
                    Grid__onPress={() => this.props.navigation.navigate('alerts')}
