...
class HistoryReplay extends Component {

    static navigationOptions = {
        header: null,
        // drawerLabel: 'History Replay',
        ...
        return(
            <View style={{ flex: 1 }}>
                ...
                <Grid 
                    ...
                    Grid__onPress={(data, data1) => this.props.navigation.navigate('historyLocation', { data, data1 })}
                    Grid__screen='HistoryReplay'
